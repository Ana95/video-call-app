...
public class CameraVideoCapturer extends BaseVideoCapturer implements PreviewCallback, BaseVideoCapturer.CaptureSwitch {

    private static final String LOG_TAG = CameraVideoCapturer.class.getSimpleName();
    ...
    public CameraVideoCapturer(Context context, Publisher.CameraCaptureResolution resolution,
            ...
            if (data.length == expectedFrameSize) {
                ...
                if (metadataSource != null) {
                    ...
                    provideByteArrayFrame(data, NV21, captureWidth,
                            captureHeight, 0, isFrontCamera(), framemetadata);
                }
                else {
                    provideByteArrayFrame(data, NV21, captureWidth,
                            captureHeight, 0, isFrontCamera());
                }
